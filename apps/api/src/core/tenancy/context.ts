...
const PERMISSION_MATRIX: Record<string, string[]> = {
  ...
  'lead-intelligence.read': ['owner', 'admin', 'analyst', 'manager'],
  'lead-intelligence.run': ['owner', 'admin', 'manager'],
  'lead-intelligence.review': ['owner', 'admin', 'manager'],
  'lead-intelligence.export': ['owner', 'admin', 'analyst', 'manager'],
